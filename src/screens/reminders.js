...
export default function Remiders(){
                ...
                <View style={{flexDirection:"row"}}>
                    ...
                    <View style={{flexDirection:'column'}}>
                        <TouchableOpacity style={[styles.appButtonContainerLarge,{borderColor:'#F2385F'}]} onPress={clickhandler}>
                                <Text style={styles.appButtonTextLarge}>Critical</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.appButtonContainerLarge,{borderColor:'#F2385F'}]} onPress={clickhandler}>
                                <Text style={styles.appButtonTextLarge}>Overdue</Text>
                        </TouchableOpacity>
                    </View>
                </View>
        </View>
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            {/* <View style={{height:"20%",width:"95%",borderWidth:1.5,borderRadius:10,marginTop:"30%",justifyContent:'center'}}>
                <View style={{flexDirection:"row"}}>
                    <Text style={{color:'black',textAlign:'center',textAlignVertical:"center",width:"35%"}}>
                        Hello World
                    </Text>
                    <Text style={{color:'black',textAlign:'center',textAlignVertical:"center",width:"30%"}}>
                        August 17,2021
                    </Text>
                    <View style={{flexDirection:'column'}}>
                        <TouchableOpacity style={[styles.appButtonContainerLarge,{borderColor:'#F2385F'}]} onPress={clickhandler}>
            ...
            {/* <View style={{height:"20%",width:"95%",borderWidth:1.5,borderRadius:10,marginTop:"1%",justifyContent:'center'}}>
                <View style={{flexDirection:"row"}}>
                    <Text style={{color:'black',padding:20}}>
                        Hello World
                    </Text>
                    <Text style={{color:'black',paddingleft:20,paddingTop:20}}>
                        August 17,2021
                    </Text>
                    <View style={{flexDirection:'column'}}>
                        <TouchableOpacity style={[styles.appButtonContainerLarge,{borderColor:'#F2385F'}]} onPress={clickhandler}>
