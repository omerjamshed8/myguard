    ...
    return (
        <Screen>
            <ScrollView>
                ...
                <View style={styles.postalCodeWrapper}>
                    <DatePick width={"90%"} fontsize={12}calendarbgcolor={"#FFFFFF"} open={true} date={startdate?startdate:props?.startDate} onChange={date => {
                        onChangestartdate(date)
                    }} />
                    <DatePick width={"90%"} fontsize={12} calendarbgcolor={"#FFFFFF"} date={enddate?enddate:props?.endDate} open={true} onChange={date => {
